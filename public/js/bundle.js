...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGlzdG9ycnJ0aW9uIiwiYSI6ImNsZmxnMWN6ejAxanYzcXA2YmhzZGg2YnAifQ.V3Ie6yk6C9NhMwiGucQynQ';
...
var resetPassword = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(password, passwordConfirm) {
    var arr, token, res;
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51Mu9AYB3hcxdXX8ax861zyktN8QZbnV41ctCWhzEVUUG5VbbFTdITrPHZAbjbd6jy1epSYGzz5v4BSCeZnw5GYKa00HjZikN2T');
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    (0, _authentication.signup)(userName, email, password, passwordConfirm);
  });
}
if (loginForm) {
...
if (forgotPasswordForm) {
  forgotPasswordForm.addEventListener('submit', function (e) {
    ...
    (0, _authentication.forgotPassword)(email);
  });
}
if (resetPasswordForm) {
  resetPasswordForm.addEventListener('submit', function (e) {
    ...
    (0, _authentication.resetPassword)(password, passwordConfirm);
  });
}
if (logOutBtn) {
